...
var depsPath = Path.Combine(AppContext.BaseDirectory, "SrvInventoryDumper.deps.json");
...
File.WriteAllText(
    ...
    MdTable(
        ...
        [
            ...
            "The executable pin for this rule is `tests/SrvBehavioralTests/DependencyInjectionHandlerTests.cs`.",
        ]
    )
);
...
if (opts.TryGetValue("--readme", out var readmePath))
{
    ...
    sb.AppendLine();
    sb.AppendLine("<!-- GENERATED by tools/SrvInventoryDumper — do not edit by hand. Regenerate with tools/generate-baseline.sh -->");
    sb.AppendLine();
    ...
    foreach (var e in assemblyEntries)
    {
        ...
        sb.AppendLine($"| {e.Name} | {e.PackageVersion} | {e.PublicTypes} | {injCount} | [server/api-surface/{e.Name}.cs](server/api-surface/{e.Name}.cs) |");
    }
...
static string MdTable(string title, string[] header, IEnumerable<string[]> rows, IEnumerable<string>? preamble = null)
{
    ...
    sb.AppendLine($"# {title}");
    sb.AppendLine();
    sb.AppendLine("<!-- GENERATED by tools/SrvInventoryDumper — do not edit by hand. -->");
    sb.AppendLine();
